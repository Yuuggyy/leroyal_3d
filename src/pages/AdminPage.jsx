...
const C = {
  ...
  danger:      '#C0392B',
  warning:     '#D4891A',
  goldDeep:    '#8C6900', // high-contrast accent for text on white/cream backgrounds
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 44 }}>
          <div style={{
            ...
            boxShadow: `0 8px 32px rgba(255,193,7,0.35)`,
          }}>
            ...
            <div>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} required autoFocus
                style={{
                  ...
                  background: 'rgba(255,255,255,0.07)', border: `1.5px solid rgba(255,193,7,0.25)`,
        ...
        <p style={{ textAlign: 'center', color: 'rgba(245,237,216,0.25)', fontSize: 12, marginTop: 28 }}>
          Le Royal · L'excellence à Kinshasa
        </p>
      </div>
    </div>
  );
...
function CommandesTab() {
  ...
  const badgeStyle = (statut) => ({
    recue:     { bg: `rgba(255,193,7,0.15)`, color: C.goldDeep },
          ...
          {filtered.map(cmd => {
            ...
            return (
              <div key={cmd.id} style={{
                ...
                border: `1px solid ${C.border}`, boxShadow: `0 2px 10px rgba(26,35,126,0.06)`,
...
function ProduitsTab() {
  ...
  return (
    <div>
      ...
      {form && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(26,35,126,0.45)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: 20 }}>
          <div style={{ background: '#fff', borderRadius: 20, padding: 32, width: '100%', maxWidth: 480, boxShadow: '0 20px 60px rgba(26,35,126,0.2)' }}>
...
function CategoriesTab() {
  ...
  return (
    <div>
      ...
      {form && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(26,35,126,0.45)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: 20 }}>
          <div style={{ background: '#fff', borderRadius: 20, padding: 32, width: '100%', maxWidth: 400, boxShadow: '0 20px 60px rgba(26,35,126,0.2)' }}>
            <h3 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 22, color: C.primary, marginBottom: 24 }}>
...
function ParametresTab() {
  ...
  const cardStyle  = { background: '#fff', borderRadius: 16, border: `1px solid ${C.border}`, boxShadow: `0 2px 10px rgba(26,35,126,0.06)`, padding: 24, marginBottom: 20 };
    ...
    <div>
      ...
      <div style={cardStyle}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <input value={nomRestaurant} onChange={e => setNom(e.target.value)} style={{ ...inputStyle, flex: 1, minWidth: 200 }} placeholder="Le Royal" />
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: C.cream }}>
      ...
      <aside style={{
        ...
        boxShadow: '4px 0 24px rgba(26,35,126,0.18)',
      }}>
        {/* Header sidebar */}
        <div style={{ padding: '0 24px 24px', borderBottom: `1px solid rgba(255,193,7,0.18)`, marginBottom: 12 }}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 20, color: C.beige, fontWeight: 700, lineHeight: 1.2 }}>Le Royal</h2>
        ...
        <nav style={{ flex: 1, padding: '0 12px', display: 'flex', flexDirection: 'column', gap: 4 }}>
          {TABS.map(t => (
            <button key={t.id} onClick={() => setTab(t.id)} style={{
              ...
              background: tab === t.id ? `rgba(255,193,7,0.18)` : 'transparent',
        ...
        {/* Footer sidebar */}
        <div style={{ padding: '12px 16px', borderTop: `1px solid rgba(255,193,7,0.12)`, display: 'flex', flexDirection: 'column', gap: 8 }}>
          <button onClick={() => window.open('/', '_blank')} style={{
            width: '100%', padding: '9px 14px', borderRadius: 10, border: `1px solid rgba(255,193,7,0.25)`,
